...
if use_client_gen:
    train_client = DataGeneratorClient(port=5555, host="localhost", hwm=160, batch_size=16)
    train_client.start()
    train_di = train_client.gen()
    train_samples = 525 #52597

    val_client = DataGeneratorClient(port=5556, host="localhost", hwm=160, batch_size=16)
    val_client.start()
